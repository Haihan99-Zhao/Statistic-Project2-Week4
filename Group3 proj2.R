...
# (3) Multiple discussions on the code details and optimization algorithm to speed up
#     the runtime.Eventually, finalize the submission version together.

# The GitHub URL of our repository is: https://github.com/Haihan99-Zhao/Statistic-Project2-Week4.git
# 
...
deconv <- function(t, deaths, n.rep=100, bs = FALSE, t0 = NULL){
  ...
  for (j in 1:n.rep) {
    ...
    if (bs){
      ...
      plot(1:length_max, d_simulation, main = "[bs]: Quantify model Uncertainty.n", 
           type = "l", lty = 2,  col = "blue", xlab = "date",
           ylab = "Number of Victims", ylim = fig1_y_range)
      ...
      # The 4th "type" defines graph types, and "l" means *Line chart.
      # The 5th "col" defines the color of line.
      # The 6th "lty" defines the type of line, 2 means dashed line.
      # The "xlab" and "ylab" label the two axes.
      # The "ylim" means the range displayed on the y-axis
      
      lines(1:length_max, d_real,type = "l", col = "darkgreen", lty = 2)
      ...
      legend("topright",
             legend = c("Estimate Death", "simulate Death", "Convergent Incidence with subtle change "),  
             col = c("blue", "darkgreen", "darkorange"), lty = c(2, 2, 1), cex = 0.8)                                 
      # "legend" function adds a legend to the existing  graph.
      # The 1st string input defines legend position. "col" defines color. 
      # "lty " defines the types of lines and 1 means solid line.
      ...
      plot(1:length_max, d_simulation, main = "[Training]: Convergence Situation", type = "l",  
           lty = 2, col = "blue", xlab = "date", ylab = "Number of Victims",
           ylim = fig1_y_range)
...
# "adjustcolor" function will help us figure out this problem
# to show them. 
...
# day 84 is the first day of UK lockdown, we draw a Vertical line
# with red color to show it. Combine all lines into evaluate
...
# The fit will improve as the number of iterations increases, and eventually,
# the blue line and the darkgreen line will essentially overlap.
